...
<div id="product-table" class="container" >
    <div class="row">
        <div class="col-md-12">
            <h4> ${sellerName}, these products are added on your Ecommerce dashboard</h4>
            <div class="table-responsive">
                <table id="mytable" class="table table-bordred table-striped">
                    ...
                    <tbody>
                    <c:forEach var="e" items="${sellerProdList}">
                        <tr>
                            <!-- <td><img src="${e.image}" alt="Image Unavailable" width="100" height="100"></td> -->
                            <td>${e.productName}</td>
                            <td>${e.productDescription}</td>
                            <td>${e.price}</td>
                            <td><a data-placement="top" data-toggle="tooltip" href="/ecom/delete/${e.productId}"  action="" title="Delete"><button class="submit" name="add"><i class="fas fa-trash-alt"></i></button></a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
